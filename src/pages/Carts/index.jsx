          ...
          {carts.length > 0 && (
            ...
            >
              ...
              >
                    ...
                    <Typography variant="h6" textAlign={'right'}>{priceInfo?.totalQuantity}</Typography>
                    </Card>
                    <Card
                sx={{
                  display: 'flex',
              ...
              >
                    ...
                    <Typography variant="h6" component='div' textAlign={'right'}>{priceInfo?.totalPrice.toFixed(2)}$</Typography>
                    </Card>
                    <Card
                sx={{
                  display: 'flex',
              ...
              >
                    ...
                    <Typography variant="h6" component='div' textAlign={'right'}>{priceInfo?.totalDiscount.toFixed(2)}$</Typography>
                    </Card>
                    <Card
                sx={{
                  display: 'flex',
              ...
              >
                    ...
                    <Typography variant="h6" component='div' textAlign={'right'}>{priceInfo?.grantTotal.toFixed(2)}$</Typography>
                    </Card>
